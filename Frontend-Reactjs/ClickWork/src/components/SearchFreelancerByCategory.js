...
const ViewFreelancer = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      const res = await axios.get("http://127.0.0.1:8000" + window.location.pathname+"1");
      setPosts(res.data);
...
class SearchFreelancerByCategory extends Component {
...
SearchFreelancerByCategory.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(SearchFreelancerByCategory));