    ...
    <dl className="dictionary">
      {posts.map(profile => (
        <div className="term">
          ...
          <a class="style-btn" href={"/client"+window.location.pathname+"/to"+profile.FreelancerId}><button style={{"marginTop":"10px", "fontSize":"16px"}} type="button" className="btn btn-outline-success submit ">Invite</button></a>
