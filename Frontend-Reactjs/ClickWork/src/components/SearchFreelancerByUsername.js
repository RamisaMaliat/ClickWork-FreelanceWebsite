...
class SearchFreelancerByUsername extends Component {
  ...
  searchByUsername() {
    ...
    let usernames = document.getElementsByClassName('search_user');
      ...
      <div>
        ...
        <div class="container">
          ...
          <div id="myBtnContainer" style={{"marginBottom":"10px"}}>
            ...
            <a href="/searchfreelancersbyusername"><button class="btn search-btn active" >Username</button></a>
          ...
          <input style={{ "marginBottom": "10px" }} class="form-control mr-sm-2 fa" type="text" name="" id="myInput"
              placeholder="search by username" onKeyUp={this.searchByUsername} />
...
SearchFreelancerByUsername.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(SearchFreelancerByUsername));