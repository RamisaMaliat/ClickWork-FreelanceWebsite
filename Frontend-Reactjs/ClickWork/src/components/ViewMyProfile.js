...
class ViewMyProfile extends React.Component {
  ...
  fetchData() {
    ...
    fetch(process.env.REACT_APP_API + "getprofilepicture",
      ...
      fetch(process.env.REACT_APP_API + "getrate",
      {
        headers: {
          'Authorization': 'Bearer ' + usertoken
        }
    ...
    const items = profiles.map((profile) =>
      <div className="term">
        <dt>
          ...
          {this.state.rate ? <dd><button style={{ "fontSize": "18px"}} type="button" className="btn "><span>&#9998; </span></button><span class="text-primary" style={{ "fontSize": "22px"}}> ${this.state.rate}/hr</span><hr/></dd>:""}
          
        </dt>
        
        {(!(profile.Description) && !(this.state.rate)) ? <dd><a href="/addbio"><button type="button" style={{ "marginTop": "20px","marginBottom": "20px" }} className="btn btn-outline-info">Add Bio</button></a><a href="/addrate"><button style={{ "marginTop": "20px","marginBottom": "20px" }} type="button" className="btn btn-outline-info">Add Hourly Rate</button></a></dd>:""}
        {((profile.Description) && !(this.state.rate)) ? <dd><a href="/addrate"><button style={{ "marginTop": "10px","marginBottom": "10px" }} type="button" className="btn btn-outline-info">Add Hourly Rate</button></a></dd>:""}
        {(!(profile.Description) && (this.state.rate)) ? <dd><a href="/addbio"><button style={{ "marginTop": "20px","marginBottom": "30px" }} type="button" className="btn btn-outline-info">Add Bio</button></a></dd>:""}

        {profile.Description ? <div style={{ "paddingBottom": "20px"}}><button type="button" className="btn " style={{ "fontSize": "20px"}}><span>&#9998; </span></button><dd ><span style={{ "fontSize": "15px"}}>{profile.Description}</span></dd><hr/></div>:""}
