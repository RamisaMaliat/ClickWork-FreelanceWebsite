...
class SearchFreelancer extends Component {
      ...
      <div>
        ...
        <div class="container">
          ...
          <div id="myBtnContainer" style={{"marginBottom":"10px"}}>
            ...
            <a href="/searchfreelancers"><button class="btn search-btn active" >Show all</button></a>
