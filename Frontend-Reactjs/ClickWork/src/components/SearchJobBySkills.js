...
class SearchJobBySkills extends Component {
  onLogout = (e) => {
    e.preventDefault();
    this.props.logout();
  };
      ...
      <div>
        ...
        <div class="container">
          ...
          <div id="myBtnContainer" style={{"marginBottom":"10px"}}>
            ...
            <a href="/searchjobsbyskills"><button class="btn search-btn active">Skills</button></a>
          ...
          <div class="dictionary" style={{ "margin": "auto", "width": "50%" }} >
            <input style={{ "marginBottom": "10px" }} class="form-control mr-sm-2 fa" type="text" name="" id="myInput"
              placeholder="search by required skills" onKeyUp={this.searchBySkills} />
          </div>
