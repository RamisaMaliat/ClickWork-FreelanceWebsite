...
class SearchFreelancerByCategory2 extends Component {
  ...
  constructor() {
    ...
    let var_category = "";
    for (var i = 28; i < window.location.pathname.length; i++) {
  ...
  fetchData() {
    ...
    document.getElementById('selected').value = this.state.category;
  ...
  searchByCategory(event) {
    ...
    let path = "/searchfreelancersbycategory" + document.getElementById('selected').value;
    console.log(path);
  ...
  render() {
    ...
    const items = categories.map((post) =>
      <option selected={this.state.category==post.CategoryID} value={post.CategoryID}>{post.CategoryName}</option>
    );
        ...
        <div class="container">
          ...
          <div class="dictionary" style={{ "margin": "auto", "width": "50%" }} >
            <div id="myBtnContainer" style={{ "marginBottom": "10px" }}>
              ...
              <a href="/searchfreelancersbyname"><button class="btn search-btn" >Name</button></a>
              <a href="/searchfreelancersbycategory"><button class="btn search-btn active" >Field of work</button></a>
          ...
          <div class="dictionary" style={{ "margin": "auto", "width": "50%" }} >
            <form onSubmit={this.searchByCategory}>
              ...
              <select id='selected' class="form-select form-select-lg form-control mr-sm-2"
                name="category" required placeholder="select a category" style={{ "marginBottom": "10px", "fontSize": "15px", "width": "80%", "display": "inline" }}>
                {items}
              </select>
...
SearchFreelancerByCategory2.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(SearchFreelancerByCategory2));