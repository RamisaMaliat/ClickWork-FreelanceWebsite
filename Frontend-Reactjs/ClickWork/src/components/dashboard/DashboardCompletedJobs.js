...
const ViewJobs = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      const res = await axios.get(process.env.REACT_APP_API + 'freelancer/viewcompletedjobs',
        {
          headers: {
...
class DashboardCompletedJobs extends Component {
  onLogout = (e) => {
    e.preventDefault();
    this.props.logout();
  };
      ...
      <app>
        ...
        <div class="container" style={{ "height": "100px", "paddingTop": "0px" }} >
          <ul class="nav nav-tabs" >
            ...
            <li role="presentation" class="active" style={{ "paddingRight": "40px" }}><a>Completed Jobs</a></li>
...
DashboardCompletedJobs.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(DashboardCompletedJobs));