    ...
    <dl className="dictionary">
      {posts.map(post => (
        <div className="term" style={{"marginBottom":"70px"}}>
          ...
          <h4 style={{"paddingTop":"20px"}}><b>Invited By : </b></h4>
...
const ViewJobs = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      const res = await axios.get(process.env.REACT_APP_API + 'freelancer/viewinvitedjobs',
        {
          headers: {
      ...
      <app>
        ...
        <div class="container" style={{ "height": "100px", "paddingTop": "0px" }} >
          <ul class="nav nav-tabs" >
            ...
            <li role="presentation" class="active" style={{ "paddingRight": "40px" }}><a>My Invitations</a></li>
...
DashboardInvitations.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(DashboardInvitations));