...
const ViewFreelancer = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      const res = await axios.get("http://127.0.0.1:8000" + window.location.pathname+"/invitations");
      setPosts(res.data);
      setLoading(false);
    };
...
class ViewJobDetailsByClient extends React.Component{
  constructor(){
      super();
      this.state={
          jobs:[],
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
       ...
       <div class="container" style={{ "height": "100px", "paddingTop": "0px" }} >
          <ul class="nav nav-tabs" >
            <li role="presentation" class="active" style={{ "paddingRight": "10px" }}><a href="">Invitations</a></li>
            <li role="presentation" style={{ "paddingRight": "10px" }}><a href={window.location.pathname+"/proposals"}>Proposals</a></li>
            <li role="presentation" style={{ "paddingRight": "10px" }}><a href={window.location.pathname+"/assigned"}>Assigned to</a></li>
...
ViewJobDetailsByClient.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(ViewJobDetailsByClient));