...
class SubmitProposal extends Component {
    ...
    handleSubmit(event) {
        ...
        fetch(process.env.REACT_APP_API + 'freelancer/sentProposal', {
            method: 'POST',
            headers: {
            ...
            .then((result) => {
                if (result == true) {
                    this.props.history.push("/freelancejobs");
                    toast.info("You sent a proposal!",
            ...
            <div class="center-block " style={{ "maxWidth": "700px", "padding": "10px", "marginTop": "30px", backgroundColor: "#f5f5f5" }}>
                ...
                <div class="mt-4 mb-4 mx-auto rounded pt-4 " style={{ backgroundColor: "#f5f5f5" }} >
                    <div class="text-center col log-in-div" style={{ backgroundColor: "#f5f5f5" }} >
                        ...
                        <h3 class="green-text"><b>Tell something about you!</b></h3>
                        <hr />
                    </div>
