    ...
    <dl className="dictionary">
      {posts.map(job => (
        <div className="term">
          ...
          <Col>
          <dt>
            <span style={{"color":"green"}}>{job.Headline}</span>
          </dt>
          </Col>
          </Row>
          ...
          {window.location.pathname=="/findWork" ? "":<a href={"/jobs/"+job.JobId}><button type="button" className="btn btn-outline-success submit">Submit Proposal</button></a>}
          ...
          <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="findWork">Find Work</a>
                </li>
                <li class="nav-item">
