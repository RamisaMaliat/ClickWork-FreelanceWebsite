...
class SearchFreelancerByCountry extends Component {
      ...
      <div>
        ...
        <div class="container">
          ...
          <div id="myBtnContainer" style={{"marginBottom":"10px"}}>
            ...
            <a href="/searchfreelancersbycountry"><button class="btn search-btn active">Country</button></a>
          </div>
          </div>
          <div class="dictionary" style={{ "margin": "auto", "width": "50%" }} >
...
SearchFreelancerByCountry.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(SearchFreelancerByCountry));