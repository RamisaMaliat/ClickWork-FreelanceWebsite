...
class ViewJobDetailsByClient3 extends React.Component{
  constructor(){
      super();
      this.state={
          jobs:[],
    ...
    return (
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
       ...
       <div class="container" style={{ "height": "100px", "paddingTop": "0px" }} >
          ...
          <li role="presentation" style={{ "paddingRight": "10px" }}><a href={"/client/job/details/"+this.state.job+"/proposals"}>Proposals</a></li>
            <li role="presentation" class="active" style={{ "paddingRight": "10px" }}><a href="">Assigned to</a></li>
...
ViewJobDetailsByClient3.propTypes = {
...
export default connect(mapStateToProps, {
  logout
})(withRouter(ViewJobDetailsByClient3));