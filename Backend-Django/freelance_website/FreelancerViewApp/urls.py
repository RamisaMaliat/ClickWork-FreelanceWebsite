...
urlpatterns = [
    path('getrate',views.getrate,name=''),
    ...
    path('job/client/assignjob<slug:jobid>/to<slug:freelancerid>',views.viewjobdetails2,name=''),
    path('job/assignjob<slug:jobid>',views.viewjobdetails,name=''),
